...
public interface ReportFieldMapper {
    ...
    @Select("SELECT id,report_id,label,field_name,field_type,match_type,searchable,search_sort,sort_order,deleted,created_at,updated_at " +
    ...
    @Insert("INSERT INTO report_field(id,report_id,label,field_name,field_type,match_type,searchable,search_sort,sort_order,deleted,created_at,updated_at) " +
            "VALUES(#{id},#{reportId},#{label},#{fieldName},#{fieldType},#{matchType},#{searchable},#{searchSort},#{sortOrder},0,NOW(),NOW())")

...
public class ReportSearchFieldEntity {
    private Long id;
    ...
    private Integer multilineEnabled;
    ...
    public Integer getMultilineEnabled() {
        return multilineEnabled;
    }

    public void setMultilineEnabled(Integer multilineEnabled) {
        this.multilineEnabled = multilineEnabled;
    }

    public String getOptionValuesJson() {
        return optionValuesJson;
    }

    public void setOptionValuesJson(String optionValuesJson) {
        this.optionValuesJson = optionValuesJson;
    }
